  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-500">Employees Processed</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">{runs[0]?._count?.records || 0}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-red-600">{runs[0]?.error_count || 0}</p>
          </CardContent>
        </Card>
      </div>
