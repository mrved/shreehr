    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ol className="list-decimal list-inside text-sm text-blue-800 space-y-1">
          <li>
            First, import <strong>Employee Data</strong> - this creates employee records and
            auto-creates departments/designations
          </li>
          <li>
            Then, import <strong>Salary History</strong> - links to existing employees by Employee
            Code
          </li>
          <li>
            Finally, import <strong>Leave Balances</strong> - links to existing employees by
            Employee Code
          </li>
        </ol>
      </div>
