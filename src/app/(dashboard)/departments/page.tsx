                  ...
                  <TableRow key={dept.id}>
                    ...
                    <TableCell>
                      <Button
                        ...
                        title={dept._count.employees > 0 ? 'Cannot delete department with employees' : 'Delete department'}
                      >
                  ...
                  <TableRow key={desig.id}>
                    ...
                    <TableCell>
                      <Button
                        ...
                        title={desig._count.employees > 0 ? 'Cannot delete designation with employees' : 'Delete designation'}
                      >
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </TableCell>
