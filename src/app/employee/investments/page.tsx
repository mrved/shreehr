                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      Your declaration is saved as draft. Upload supporting documents and submit for
                      verification.
                    </p>
                    <Link href="/employee/investments/declare">
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900">
                No Declaration for FY {currentFY}
              </h3>
              <p className="mt-2 text-sm text-gray-600 max-w-md mx-auto">
                Declare your tax-saving investments to reduce your monthly TDS deduction. Include
                80C investments, health insurance (80D), and HRA.
              </p>
              <Link href="/employee/investments/declare">
              ...
              <Card key={declaration.id}>
                ...
                <CardContent>
                  <div className="text-sm text-gray-600">
                    <p>
                      {declaration._count.proof_documents} document
                      {declaration._count.proof_documents !== 1 ? "s" : ""}
                    </p>
