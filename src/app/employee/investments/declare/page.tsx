  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/employee/investments" className="text-gray-600 hover:text-gray-900">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Financial Year {currentFY}</p>
        </div>
      </div>
          ...
          existingDeclaration
            ? {
                ...
                section_80c_home_loan_principal:
                  existingDeclaration.section_80c_home_loan_principal,
