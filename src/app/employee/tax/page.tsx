    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Investment Declarations</h2>
          <p className="text-sm text-gray-600">Submit your tax-saving investment proofs</p>
        </Link>
      </div>
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-700">
          Form 16 is a TDS certificate issued by your employer showing the tax deducted from your
          salary for a financial year. It is required for filing your income tax return. Form 16
          becomes available after the financial year ends (typically by June).
        </p>
      </div>
    </div>
  );
