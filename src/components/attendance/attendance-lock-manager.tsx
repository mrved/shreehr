        ...
        <CardContent>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            <div className="flex items-center gap-4">
              <div
                className={`h-8 w-8 rounded-full flex items-center justify-center ${lockStatus?.isLocked ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}
              >
                {lockStatus?.isLocked ? (
                  <svg
            ...
            <div className="flex gap-2">
              ...
              {lockStatus?.lock?.unlock_approved_at && (
                <Button
                  onClick={() => handleLockAction("relock")}
          ...
          {lockStatus &&
            lockStatus.daysUntilAutoLock !== null &&
            lockStatus.daysUntilAutoLock <= 5 && (
